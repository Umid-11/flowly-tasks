...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    setIsLoading(true);
    try {
      const success = await registerUser(data.username, data.firstName, data.lastName, data.email, data.password, data.role as UserRole);
      if (success) {
        toast({
          title: 'Account created!',
          description: 'Welcome to Flowly.',
        });
