...
export const mockTeams: Team[] = [
  {
    ...
    description: 'Backend and frontend developers working on core platform',
  ...
  },
  {
    id: '2',
    name: 'Design Team',
    description: 'UI/UX designers crafting beautiful user experiences',
    members: [mockUsers[1], mockUsers[5]],
    createdBy: '1',
    color: '#ec4899',
    createdAt: new Date('2024-02-01'),
